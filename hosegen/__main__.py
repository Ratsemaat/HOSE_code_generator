...
if args.AtomNumber is not None:
    value = gen.get_Hose_codes(molStereo1,args.AtomNumber,usestereo=True,wedgebond=wedgemap1)
    print(value)
else:
    for idx,atom in enumerate(molStereo1.GetAtoms()):
        value = gen.get_Hose_codes(molStereo1,idx,usestereo=True,wedgebond=wedgemap1)
        print(idx,":",value)
