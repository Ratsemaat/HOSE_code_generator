...
parser.add_argument(
    ...
    "--AtomNumber",
    type=int,
    help="Atom number to generate HOSE code for, starts at 0, if missing, all atoms will be done",
    required=False,
)
parser.add_argument(
    "-s",
    ...
    const=True,
    default=False,
    help="strict mode (default: %(default)s)",
    required=False,
)
parser.add_argument(
    "-u",
    ...
    const=True,
    default=True,
    help="generate stereo HOSE code (default: %(default)s)",
    required=False,
)
parser.add_argument(
    "-m",
    ...
    type=int,
    default=5,
    help="number of spheres to use (default: %(default)s)",
    required=False,
)
parser.add_argument(
    "-r",
    ...
    const=True,
    default=False,
    help="include ring size in centre code (default: %(default)s)",
    required=False,
)
...
if args.AtomNumber is not None:
    value = gen.get_Hose_codes(
        molStereo1,
        args.AtomNumber,
        usestereo=args.UseStereo,
        strict=args.Strict,
